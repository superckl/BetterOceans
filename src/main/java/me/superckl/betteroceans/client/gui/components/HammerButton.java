...
public class HammerButton extends GuiButton{
	...
	public void drawButton(final Minecraft mc, final int p_146112_2_, final int p_146112_3_){
		...
		RenderHelper.drawTexturedRect(RenderData.HAMMER_BUTTON, this.xPosition, this.yPosition, this.getHoverState(this.field_146123_n) == 2  && this.enabled ? 18:0, 0, 18, 18, 36, 18, 1F);
	}
